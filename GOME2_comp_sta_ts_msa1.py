...
no2_gome2_ena = no2_gome2[:,30:36,18:25]
dno2_ena11 = (no2_gome2_ena[1,:,:]-no2_gome2_ena[0,:,:])/no2_gome2_ena[3,:,:]
dno2_ena07 = (no2_gome2_ena[6,:,:]-no2_gome2_ena[4,:,:])/no2_gome2_ena[7,:,:]
no2_gome2_eur = no2_gome2[:,31:39,36:41]
dno2_eur11 = (no2_gome2_eur[2,:,:]-no2_gome2_eur[0,:,:])/no2_gome2_eur[3,:,:]
dno2_eur07 = (no2_gome2_eur[6,:,:]-no2_gome2_eur[4,:,:])/no2_gome2_eur[7,:,:]
no2_gome2_neq = no2_gome2[:,16:20,37:44]
dno2_neq11 = (no2_gome2_neq[2,:,:]-no2_gome2_neq[0,:,:])/no2_gome2_neq[3,:,:]
model_hour=24
